...
| Document | Purpose |
|----------|---------|
| **setup_files/SETUP_COLAB.md** | Colab step-by-step |
| **setup_files/SETUP_LOCAL.md** | Local & GCP setup |
| **setup_files/TROUBLESHOOTING.md** | Common issues |
...
```
README.md → setup_files/SETUP_COLAB.md → Run experiment ✅
...
| **Finding setup help** | Grep README | Go to setup_files/ |
